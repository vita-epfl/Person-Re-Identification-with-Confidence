...
class ImageDataset(Dataset):
    ...
    def __init__(self, dataset,crop=True, transform=None, return_path = False):
    ...
    def __getitem__(self, index):
        img_path, pid, bbox_x1, bbox_y1, bbox_x2, bbox_y2 = self.dataset[index]
        img = read_image(img_path)
        if self.crop:
            img = img.crop((bbox_x1, bbox_y1, bbox_x2, bbox_y2))
...
class ImageDataset_stanford(Dataset):
    """Image Person ReID Dataset"""
    def __init__(self, dataset, crop=True, transform=None, return_path = False):
        self.dataset = dataset
        self.transform = transform
